...
namespace Sistema.DAL
{
    public class CompraDao
    {
        ...
        public string RealizarCompra(Fornecedor fornecedor, DateTime data, List<CompraEstoque> compraEstoque)
        {
            ...
            {
                cmd2.CommandText = "insert into tb_compra_estoque values(@fk_cod_estoque, IDENT_CURRENT('tb_compra'), @quantidade, @valor) update tb_estoque set quantidade = quantidade + @quantidade where cod_estoque = @fk_cod_estoque";
